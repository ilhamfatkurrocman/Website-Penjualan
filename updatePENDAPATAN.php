    ...
    <body>
        <div class="wrapper">
            ...
            <br>
				...
				<?php
	      		$query = mysqli_query($connect, "select * from pendapatan where id_pendapatan = '".$_GET['kode']."';");
						...
						<div class="card">
							<div class="card">
								...
								<div class="card-body card-block">
									...
									<form method="post" action="updatesimpanpendapatan.php" class="form-horizontal">
										<div class="row form-group">
											<div class="col col-sm-5"><label class=" form-control-label">ID Pendapatan</label></div>
											<div class="col col-sm-5"><input type="text1" name="id_pendapatan" placeholder="Masukkan ID" class="form-control" value="<?php echo $data['id_pendapatan']; ?>"></div>

										</div>
										<div class="row form-group">
											<div class="col col-sm-5"><label for="input-normal" class=" form-control-label">Pendapatan Budidaya</label></div>
											<div class="col col-sm-5"><input type="text1" id="input-normal" name="pendapatan" placeholder="Masukkan Nominal" class="form-control" value="<?php echo $data['pendapatan']; ?>"></div>
										</div>
										<div class="row form-group">
											<div class="col col-sm-5"><label for="input-normal" class="form-control-label">Modal</label></div>
											<div class="col col-sm-5"><input type="text1" id="input-normal" name="modal" placeholder="Masukan Nominal" class="form-control" value="<?php echo $data['modal'];?>"></div>
										</div>
										<div class="row form-group">
											<div class="col col-sm-5"><label for="input-normal" class=" form-control-label">Keuntungan</label></div>
											<div class="col col-sm-5"><input type="text1" id="input-normal" name="tot_untung" placeholder="" disabled="true" class="form-control" value="<?php echo $data['tot_untung']; ?>"></div>
										</div>
										<div class="row form-group">
											<div class="col col-sm-5"><label for="input-normal" class="form-control-label">Pajak</label></div>
											<div class="col col-sm-5"><input type="text1" id="input-normal" name="pajak" placeholder="" disabled="tru" class="form-control" value="<?php echo $data['pajak'];?>"></div>
										</div>
									...
									<tbody>
										...
										?>
											<tr>
												...
												<td><a href="updatePENDAPATAN.php?kode=<?php echo $data['id_pendapatan'];?>" <!--Pakai tanda ? karena membawa 	parameter-->
