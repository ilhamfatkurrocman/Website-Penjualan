						...
						<div class="card">
							<div class="card">
								...
								<div class="card-body card-block">
									<form method="post" action="simpanpetani.php" class="form-horizontal">
										<div class="row form-group">
											<div class="col col-sm-3"><label class=" form-control-label">ID Petani</label></div>
											<div class="col col-sm-6"><input type="text1" name="id_petani" placeholder="Masukkan ID" class="form-control"></div>

										</div>
										<div class="row form-group">
											<div class="col col-sm-3"><label for="input-normal" class=" form-control-label">Nama Petani</label></div>
											<div class="col col-sm-6"><input type="text1" id="input-normal" name="nama_petani" placeholder="Masukkan Nama Petani" class="form-control"></div>
										</div>
										<div class="row form-group">
											<div class="col col-sm-3"><label for="input-normal" class=" form-control-label">Alamat</label></div>
											<div class="col col-sm-6"><input type="text1" id="input-normal" name="alamat" placeholder="Alamat" class="form-control"></div>
										</div>
										<div class="card-footer">
    										<a href="datapetani.php?kode=<?php echo $row['id_petani'];?>" <!--Pakai tanda ? karena membawa parameter-->
									...
									<table class="table">
    									...
    									<tbody>
											...
											<tr>
												...
												<td>
                                                    <a href="updatePETANI.php?kode=<?php echo $data['id_petani'];?>" >
												    ...
												    <a href="hapusdatapetani.php?id_petani=<?php echo $data['id_petani'];?>" <!--Pakai tanda ? karena membawa parameter-->
                                                        <button type="submit" class="btn btn-danger btn-sm" name="id_petanir">
