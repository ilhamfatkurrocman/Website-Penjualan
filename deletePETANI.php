										...
										<tbody>
											...
											?>
												<tr>
													...
													<td>
														<a href="updatePETANI.php?kode=<?php echo $data['id_petani'];?>" <!--Pakai tanda ? karena membawa 	parameter-->
														<button type="submit" class="btn btn-primary btn-sm" name="aksi" value="edit">
														<i class="fa fa-dot-circle-o"></i> Edit
														</button>
													</a>
													<a href="deletePETANI.php?kode=<?php echo $data['id_petani'];?>"
														<button type="submit" class="btn btn-danger btn-sm" name="aksi" value="hapus">
