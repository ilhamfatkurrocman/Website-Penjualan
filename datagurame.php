						...
						<div class="card">
							<div class="card">
								...
								<div class="card-body card-block">
									<form method="post" action="simpangurame.php" class="form-horizontal">
										<div class="row form-group">
											<div class="col col-sm-3"><label class=" form-control-label">ID Jenis</label></div>
											<div class="col col-sm-6"><input type="text1" name="id_jenisgur" placeholder="Masukkan ID " class="form-control"></div>

										</div>
										<div class="row form-group">
											<div class="col col-sm-3"><label for="input-normal" class=" form-control-label">Nama Jenis Gurame</label></div>
											<div class="col col-sm-6"><input type="text1" id="input-normal" name="nama_gur" placeholder="Masukkan Nama Jenis" class="form-control"></div>
										</div>
									...
									<table class="table">
    									...
    									<tbody>
											...
											<tr>
                                                ...
                                                <td> 
                                                    <a href="updateGURAME.php?kode=<?php echo $data['id_jenisgur'];?>" <!--Pakai tanda ? karena membawa parameter-->
                                                    ...
                                                    <a href="hapusdatagurame.php?id_jenisgur=<?php echo $data['id_jenisgur'];?>" <!--Pakai tanda ? karena membawa parameter-->
                                                     ...
                                                     <!-- <button type="button" class="btn btn-danger btn-sm" data-target ="#delete<?php echo $data['id_jenisgur'];?>">
                                                      <i class="fa fa-ban"></i> Hapus    
                                                    </button>
                                                 -->
                                                </td>
