						...
						<div class="card">
							<div class="card">
								...
								<div class="card-body card-block">
									<form method="post" action="simpanefisiensipakan.php" class="form-horizontal">
 										<div class="col-6">
                                            <div class="form-group">
                         						  <label for="input-normal" class="form-control-label mb-1">ID Transaksi</label>
                                                  <input type="text1" name="id_trans" placeholder="Masukkan ID Transaksi" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                          	 	<label for="input-normal" class=" form-control-label mb-1">Bobot Ikan Pada Waktu Akhir (Wt)</label>
                                              	<input type="number" id="input-normal" name="Wt" placeholder="(g)" class="form-control">
                                            </div>
                                        </div>
                                       	<div class="col-6">
                                        	<div class="form-group">
                                          		<label for="input-normal" class="form-control-label mb-1">ID Ikan</label>
                                          		<input type="text1" id="input-normal" name="id_ikan" placeholder="Masukkan ID Ikan" class="form-control">
                                          	</div>
                                      	</div>
                                        <div class="col-6">
                                            <div class="form-group">
                                               	<label for="input-normal" class=" form-control-label mb-1">Bobot Ikan Pada Waktu Awal (Wo)</label>
                                              	<input type="number" id="input-normal" name="W0" placeholder="(g)" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                              	<label for="input-normal" class=" form-control-label mb-1">ID Jenis</label>
                								<input type="text1" id="input-normal" name="id_jenis" placeholder="Masukkan ID Jenis" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                           		<label for="input-normal" class=" form-control-label mb-1">Jumlah Ikan Yang Mati Selama Penelitian (D)</label>
                                            	<input type="number" id="input-normal" name="D" placeholder="(Ekor)" class="form-control">
                                            </div>                                            
                                        </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                          		...
                                          		<input type="text1" id="input-normal" name="id_pakan" placeholder="" class="form-control">
                                            </div>
                                       	</div>
                                        <div class="col-6">
                                            <div class="form-group">
                               	       			<label for="input-normal" class=" form-control-label mb-1">Bobot Pakan Yang Diberikan (F)</label>
                                     			<input type="number" id="input-normal" name="F" placeholder="(g)" class="form-control">
                                              </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                              	<label for="input-normal" class=" form-control-label mb-1">Bulan</label>
                                              	<input type="text1" id="input-normal" name="bulan" placeholder="" class="form-control">
                                            </div>
                                        </div>
                                </div>
									...
									<tbody>
										...
										?>
											<tr>
                                                ...
                                                <td>
                                                    <a href="updateEFISIENSI.php?kode=<?php echo $data['id_trans'];?>" <!--Pakai tanda ? karena membawa parameter-->
