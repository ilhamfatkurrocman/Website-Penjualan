    ...
    <body>
        <div class="wrapper">
            ...
            <br>
				...
				<?php
	      		$query = mysqli_query($connect, "select * from produksi where id_ikan = '".$_GET['kode']."';");
						...
						<div class="card">
							<div class="card">
								...
								<div class="card-body card-block">
									<form method="post" action="updatesimpanadmin.php" class="form-horizontal">
										<div class="row form-group">
											<div class="col col-sm-5"><label class=" form-control-label">ID Ikan</label></div>
											<div class="col col-sm-5"><input type="text1" name="id_ikan" placeholder="Masukkan ID" disabled="true" class="form-control" value="<?php echo $data['id_ikan']; ?>"></div>

										</div>
										<div class="row form-group">
											<div class="col col-sm-5"><label for="input-normal" class=" form-control-label">Nama Jenis Gurame</label></div>
											<div class="col col-sm-5"><input type="text1" id="input-normal" name="jenis_ikan" placeholder="Masukkan Jenis Ikan" class="form-control" value="<?php echo $data['jenis_ikan']; ?>"></div>
										</div>
										<div class="row form-group">
											<div class="col col-sm-5"><label for="input-normal" class=" form-control-label">Harga Jual</label></div>
											<div class="col col-sm-5"><input type="text1" id="input-normal" name="harga_jual" placeholder="Masukkan Nominal" class="form-control" value="<?php echo $data['harga_jual']; ?>"></div>
										</div>
										<div class="row form-group">
											<div class="col col-sm-5"><label for="input-normal" class=" form-control-label">Harga Beli</label></div>
											<div class="col col-sm-5"><input type="text1" id="input-normal" name="harga_beli" placeholder="Masukkan Nominal" class="form-control" value="<?php echo $data['harga_beli']; ?>"></div>
										</div>
									...
									<tbody>
										...
										?>
											<tr>
												...
												<td><a href="updateADMIN.php?kode=<?php echo $data['id_ikan'];?>" <!--Pakai tanda ? karena membawa 	parameter-->
