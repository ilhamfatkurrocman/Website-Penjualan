...
<body class="bg-dark">
    ...
    <?php
        $koneksi = mysqli_connect("localhost", "root", "", "kelas_web") or die ("Connection Database Failed");
        IF(ISSET($_POST['login'])){
            ...
            $data = mysqli_fetch_array($hasil);
                ...
                IF($cek > 0){
                    ...
                    echo "<script language=\"javascript\">alert(\"welcome Admin\");document.location.href='admin.php';</script>";
                }else{
